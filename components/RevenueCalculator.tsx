  ...
  return (
    <div id="calculator" className="bg-gradient-to-br from-black to-gray-900 p-8 lg:p-12 rounded-2xl shadow-2xl">
      <div className="flex items-center space-x-3 mb-6">
        <Calculator className="text-green" size={32} />
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-gray-800 text-white px-4 py-3 rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-green"
          >
        ...
        <div>
          <label htmlFor="footTraffic" className="block text-white font-semibold mb-2">
            Daily Foot Traffic: <span className="text-green">{dailyFootTraffic}</span>
          </label>
          <input
            type="range"
            id="footTraffic"
            ...
            className="w-full h-3 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-green"
          />
        ...
        <div>
          <label htmlFor="daysPerWeek" className="block text-white font-semibold mb-2">
            Days Open Per Week: <span className="text-green">{daysPerWeek}</span>
          </label>
          <input
            type="range"
            id="daysPerWeek"
      ...
      <div className="mt-10 pt-8 border-t border-gray-700">
        <div className="text-center">
          ...
          <div className="text-6xl lg:text-7xl font-heading text-green mb-4">
